...
class EstatusViewSet(viewsets.ModelViewSet):
    ...
    def create(self,request):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response({'mensaje':'Estatus creado correctamente!'}, status = status.HTTP_201_CREATED)   
    ...
    def destroy(self, request, pk=None):
        ...
        if alumno:
            alumno.delete()
            return Response({'message':'Estatus eliminado correctamente'},status = status.HTTP_200_OK)
