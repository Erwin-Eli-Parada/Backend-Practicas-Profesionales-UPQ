    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_proyecto', models.CharField(blank=True, max_length=300, verbose_name='nombre_proyecto')),
                ('fecha_solicitud', models.DateTimeField(blank=True, verbose_name='Fecha de eliminacion')),
                ('metodo_conocimiento', models.CharField(blank=True, max_length=100, verbose_name='metodo_conocimiento')),
                ('calificacion', models.DecimalField(blank=True, decimal_places=2, max_digits=4, verbose_name='calificacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_asesor_ext', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encuesta', to='datos.asesorexterno')),
            ],
            options={
