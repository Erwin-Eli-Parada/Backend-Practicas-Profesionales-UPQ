...
from .api import user_api_view, user_detail_view, user_login_view, recuperar_contra_view
...
urlpatterns = [
    ...
    path('api/usuario/recuContra/', recuperar_contra_view, name="recuperar_contra_view")
]